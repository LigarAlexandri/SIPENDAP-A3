<aside id="default-sidebar"
    class="top-0 left-0 z-10 w-64 h-screen fixed transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-20 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Virtual Assistant</span>
                </a>
            </li>
            <li>
                <a href="#"
            ...
            <li>
                <a href="/daftar"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Masukkan Data Petani</span>
                </a>
            </li>
            <li>
                <a href="/verifikasi"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Verifikasi Data Petani</span>
                </a>
            </li>
        </ul>
    </div>
