...
<div class="flex flex-col justify-center items-center absolute top-10 mx-96  mt-20 mb-8 bg-white w-[1000px]  rounded-[30px]">
    <form class="relative bg-[FFFFFF] px-48 mt-4 w-auto flex flex-col space-y-3">
        ...
        <div class="flex relative z-0 w-full group">
            <div class="mb-10 mr-16">
                <label for="kelamin" class="px-4">Jenis Kelamin</label>
                <input type="text" name="nik" id="kelamin" class="block py-2.5 px-4 text-sm text-black w-[350px] border-[#72B944] focus:border-[#72B944] border-2 rounded-3xl"  placeholder="" value="{{ $kelamin->nama }}"/>
            </div>
            <div class="mr-4">
