...
@section('container')
    <div class="relative flex items-center">
        ...
        <form class="space-y-4 md:space-y-6" action="{{ route('update.berita', $broadcastBerita->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="flex flex-col justify-center items-center w-full md:w-auto md:max-w-[1000px] h-[720px] ml-[380px] mt-10">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <textarea id="isi_berita" name="isi_berita"
                                ...
                                placeholder="Tuliskan Isi Berita....">{{$broadcastBerita->isi_berita}}</textarea>
                        </div>
                        @error('isi_berita')
                            <p class="text-red-500 text-sm font-medium py-2 capitalize" role="alert">{{ $message }}</p>
                        @enderror
