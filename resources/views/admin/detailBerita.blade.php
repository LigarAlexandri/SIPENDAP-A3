...
@section('container')
    <div class="relative flex items-center">
        ...
        <div class="flex flex-col justify-center items-center w-full md:w-auto md:max-w-[1000px] h-full ml-20 mt-18 bg-white rounded-lg shadow-lg">
            <div class="w-screen px-0 flex flex-col">
                <div class="mt-4">
                    ...
                    <div class="flex w-full items-center justify-center mt-4">
                        <img src="{{ url('img/' . $broadcastBerita->thumbnail) }}" class="w-[720px] rounded-lg">
                    </div>
                    <div class="flex items-center justify-center mt-4">
                        <p class="flex ml-[200px] w-[1080px] text-center">
